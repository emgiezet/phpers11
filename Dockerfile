...
COPY docker/supervisord/supervisor.conf /etc/supervisor/supervisor.conf
COPY docker/supervisord/message_consumer.conf /etc/supervisor/conf.d/message_consumer.conf
...
ENTRYPOINT ["/bin/sh", "/srv/app/entrypoint.sh"]
